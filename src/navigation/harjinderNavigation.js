...
import { currentUser, isAppLoaded, isUserSelectedLanguageAvailable, setCurrentUser, setUserSelectedLanguageAvailable } from "../appData";
...
function NavContainer(){
  ...
  console.log('here')
   getAsyncStorage(keys.loggedInUserID).then((loggedInUserID) => {
    console.log(loggedInUserID,'===idddd===')
      if (loggedInUserID) {
          ...
          if(userData){
           ...
           getAsyncStorage(keys.lang).then((language) => {
            console.log(language,'================')
             if (language) {
                  Translator.default(language, true)
                  setUserSelectedLanguageAvailable(true);
                 console.log("setUserSelectedLanguageAvailable",setUserSelectedLanguageAvailable(true))
                 setInitRoute('Login');
                 setAppLoad(true);
                 console.log(appLoad,'===');
             } else {
